...
with open('/Users/mateusaragao/FootballGuru/data/laliga_seasons_teams.json', 'r') as file:
...
for idx,team in enumerate(laliga_seasons_teams):
    ...
    if team['season']>=2003:
        ...
        url = "http://sports.core.api.espn.com/v2/sports/soccer/leagues/esp.1/seasons/"+str(team['season'])+"/teams/"+team['id']+"/athletes"
...
print(player_stats)
file_path = 'data/stats/laliga_player_stats.json'
...
file_path = 'data/stats/laliga_player_defensive_stats.json'
...
file_path = 'data/stats/laliga_player_goalkeeping_stats.json'
...
file_path = 'data/stats/laliga_player_offensive_stats.json'
...
print(general_stats)
file_path = 'data/stats/laliga_player_general_stats.json'
